...
const ProjectCard = ({ props }) => {
  ...
  return (
    <div className="hover:scale-105 transition-all ease-in-out hover:cursor-pointer  flex flex-col justify-center items-center border border-gray-300 border-dashed rounded shadow-lg">
